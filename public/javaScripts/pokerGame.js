...
let socket = null;
let cardsImg = $('<img></img>');

cardsImg.appendTo($('body'));
cardsImg.attr('hidden', true);
cardsImg.attr('id', 'cards');
let cards = new Image();
...
let updateGameInfo = ()=>
{
	...
	success: function(res)
	{
		...
		if(res.tableCards.cardOne)
		{
			...
			canvas.drawImage({
			source: 'https://s3.amazonaws.com/express-app-dev-serverlessdeploymentbucket-fhfeowhcyov8/deck.png',
...
cards.src = 'https://s3.amazonaws.com/express-app-dev-serverlessdeploymentbucket-fhfeowhcyov8/deck.png';
cardsImg.attr('src', 'https://s3.amazonaws.com/express-app-dev-serverlessdeploymentbucket-fhfeowhcyov8/deck.png');
